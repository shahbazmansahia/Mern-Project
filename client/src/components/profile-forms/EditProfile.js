...
const EditProfile = ({ profile: {profile, loading}, CreateProfileAct, getCurrProfile, Navigate }) => {
    ...
    // for toggling social media form hide/show
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            meta: loading || !profile.social ? '' : profile.social.meta,
    ...
    const onSubmit = e => {
        ...
        createProfileAct(formData, navigate, true);
        }
    return (
        <Fragment>
                 ...
                 {displaySocialInputs && 
                    <Fragment>
                        ...
                        <div className="form-group social-input">
                            ...
                            <input type="text" placeholder="Meta URL" name="meta" value= { meta } onChange = { e => onChange(e) } />
                        </div>
...
export default connect(mapStateToProps, { createProfileAct, getCurrProfile })(EditProfile);
